...
const EventPlanner = () => {
    ...
    const clickHandle =() =>{
     alert ("This Button Has no Functionality");
    };
    return (
        ...
        <div className="event-planner-container">
            ...
            <section className="description">
                ...
                <button className="get-started-button" onClick={clickHandle}>Get Started</button>
            </section>
            ...
            <section className="testimonials">
                ...
                <div className="testimonial">
                    ...
                    <p className="author">- anonymous Customer</p>
                </div>
                <div className="testimonial">
